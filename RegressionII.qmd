...
The image highlights how the regression line can reduce the errors of our prediction. Consider the point with y coordinate 168. The error made (i.e., the distance between) by using the mean is 1.6. However, if we update our prediction by using the regression line the mistake is reduced to $168-167.17=0.83$. Squaring all of these deviations from the mean and adding them gives us $SSE=0.81+0.29+0.69+5.76+0.02=7.57$. Note how using the regression line has helped us reduce the errors in our prediction.
