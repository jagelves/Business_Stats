...
**Example:** Consider the data on students' answers to the question, what is your favorite food? You can see the data below:
...
```{r echo=FALSE, out.width="75%", fig.align='center'}
knitr::include_graphics("images/FreqDist.png")
```
