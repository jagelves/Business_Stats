...
1.  Construct a histogram using 5 classes with width 10, starting at 50 (bins: \[50,60), \[60,70), etc.). Use `geom_histogram()` with appropriate parameters. In which bin is the highest frequency? How many students scored in that range?
...
*The highest frequency is in the bin (50,60\] with 13 students.*
