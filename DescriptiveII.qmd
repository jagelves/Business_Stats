...
**Example:** Consider the data on students' answers to the question what is your favorite food?

```{r echo=FALSE, out.width="75%", fig.align='center'}
knitr::include_graphics("images/food.png")
```
Simply observing raw data can make identifying the most and least popular items challenging. A frequency distribution organizes this information into a clear table, showcasing the popularity of each item. This approach makes it much easier to pinpoint the most popular and the least popular items. Below you can see the bar graph showing frequency distribution of the food items data:

```{r echo=FALSE, out.width="75%", fig.align='center'}
knitr::include_graphics("images/FreqDist1.png")
```
We can now clearly identify that the most popular food item is sushi and the least popular item is pasta.
