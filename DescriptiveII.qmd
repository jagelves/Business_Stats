...
When working with numerical data, building a frequency distribution requires additional steps compared to categorical data. The challenge lies in the absence of predefined categories or classes. To construct a meaningful frequency distribution for numerical data, it is essential to determine the number, width, and limits of the classes.

Steps to Create a Frequency Distribution for Numerical Data:
