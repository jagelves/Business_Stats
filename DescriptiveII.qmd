...
1. Construct a frequency distribution using 7 classes with width 10, starting at 50 (bins: [50,60), [60,70), etc.). 

2. Use `geom_histogram()` with appropriate parameters.
In which bin is the highest frequency? How many students scored in that range?
