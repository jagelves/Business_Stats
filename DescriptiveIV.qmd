...
```
The table shows the deviations from the mean in the second column. You can convince yourself that these add up to zero. The third column squares the deviation. The variance, averages the numbers in the third column. The result is $s^2=977594$.
