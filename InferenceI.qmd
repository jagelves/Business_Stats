...
In conclusion, when we estimate a sample mean drawn from a random sample of the population, we know that the mean comes from a normal distribution with a mean equal to the population mean and a smaller standard deviation than the population standard deviation.
