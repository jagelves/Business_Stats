...
Since in this simple example, have access to the population, we can calculate the population mean and verify that it is $\mu=15.75$. However, in reality it is rarely that we have population data. Consider taking a random sample of three elements from the population. The table below show the possible samples, and their corresponding means.
